...
export const mockRestaurants: MockRestaurant[] = [
    {
        ...
        title: 'MONE',
        desc: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequuntur expedita accusantium incidunt quibusdam temporibus nobis minus omnis animi dolores ab praesentium error totam, est consequatur in harum quis? Delectus, praesentium.',
        hot: true,
        price: 1
    },
    {
